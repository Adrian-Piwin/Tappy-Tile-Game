...
namespace CloudOnce
{
    ...
    public static class CloudIDs
    {
        ...
        {
            public static string NormalModeHighscore
            {
                get
                {
#if UNITY_ANDROID && !UNITY_EDITOR
#if CLOUDONCE_GOOGLE
                    return "CgkI1I2DnbcGEAIQAA";
#else
                    return string.Empty;
#endif
#elif (UNITY_IOS || UNITY_TVOS) && !UNITY_EDITOR
                    return "com.tappytilenormalhighscore";
#elif UNITY_EDITOR
...
#if UNITY_ANDROID && !UNITY_EDITOR
#if CLOUDONCE_GOOGLE
                    return "CgkI1I2DnbcGEAIQAQ";
#else
                    return string.Empty;
#endif
#elif (UNITY_IOS || UNITY_TVOS) && !UNITY_EDITOR
                    return "com.tappytilehardhighscore";
#elif UNITY_EDITOR
